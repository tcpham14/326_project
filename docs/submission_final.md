...
| submissions/create/ | Can create feedback for a class. A student only has permissions to create feedbacks for themselvelves after    |  |                     | logging in                                                                                                     |  | edit_profile/       | Allows user to edit their profile settings. A student only has permissions to edit their own profile.          |
